...
if(isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) === 'xmlhttprequest') {
    ...
    if (isset($_POST['saleId'])) {
        ...
        if ($result->num_rows == 0) {
            echo 'not_exists'; // This will be the response received in AJAX
        }
        // Close the statement
        $stmt->close();
          ...
          <div class="inputBox mx-auto shadow p-5 mt-4">
              ...
              <form id="lcsInsertForm" method="post" action="licenseInsert.php">
                  ...
                  <tr>
                      ...
                      <td><input type="text" min="0" class="input" name="saleId" id="saleId" value="<?php echo $html_values['SALE_ID'] ?? ''; ?>"></td>
                    </tr>
                    <tr> 
