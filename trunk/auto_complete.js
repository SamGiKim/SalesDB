...
window.addEventListener("load", function() {
    ...
    switch(location.pathname) {
        case "/dashboard.html": // 생성된 대시보드
        case "/dashboard.php": // 대시보드
            new AutoComplete(document.querySelector("#search_query"), {cmd: "002", type:"*"});
        break;
        case "/salesInsert.php": // 거래명세서 입력
        ...
        break;
        case "/salesUpdate.php": // 거래명세서 수정
        case "/salesSearch.php": // 거래명세서 검색
        ...
        break;
        case "/licenseInsert.php": // 라이센스 입력
            ...
            // <<<<<< 230920 명세서에 적힌 보증기간 가져오기 
        break;
        case "/licenseSearch.php": // 라이센스 검색
            new AutoComplete(document.querySelector("#saleId"), {cmd: "001", type: "S"} ); // 명세서번호
            new AutoComplete(document.querySelector("#SN"),     {cmd: "001", type: "D"} ); // 시리얼번호
        break;
    }
